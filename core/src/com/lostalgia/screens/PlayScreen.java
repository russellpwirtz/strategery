...
import com.lostalgia.b2dworldutils.WorldContactListener;
import com.lostalgia.builders.WorldBuilder;
import com.lostalgia.gamesys.GameManager;
import com.lostalgia.systems.*;
...
//    private PillSystem pillSystem;
    ...
    private Player1System player1System;
...
//    private float ambientLight = 0.5f;
    private float ambientLight = 1f;

    private boolean changeScreen;
    private float changeScreenCountDown = 2.0f;

    public PlayScreen(Strategery game) {
        this.game = game;
    ...
    public void show() {
        ...
        player1System = new Player1System();
...
//        pillSystem = new PillSystem();
        ...
        engine.addSystem(player1System);
...
//        tiledMap = new TmxMapLoader().load("map/map.tmx");
        tiledMap = new TmxMapLoader().load("map/stratego-02.tmx");
...
//        playerSprite = new Sprite(new TextureRegion(new Texture("images/boy-01.png"), 0, 0, 16, 16));
//        playerSprite.setBounds(8f, 21.5f, 16 / GameManager.PPM, 16 / GameManager.PPM);
    ...
    public void render(float delta) {
        ...
        if (changeScreen) {
            ...
            player1System.setProcessing(false);
            enemySystem.setProcessing(false);
...
//            playerSprite.setPosition(8 + i, 21.5f);

...
import com.lostalgia.utils.Box2dLocation;
import com.lostalgia.utils.Box2dSteeringUtils;
...
public class EnemyAI implements Steerable<Vector2> {
    ...
    public EnemyAI(Body body, float boundingRadius) {
        this.body = body;
